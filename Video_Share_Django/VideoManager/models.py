...
class VideoInfo(models.Model):
    ...
    videoPlayNum = models.IntegerField(default=0, blank=True)
    videoLikeNum = models.IntegerField(default=0, blank=True)
    videoFavorNum = models.IntegerField(default=0, blank=True)
